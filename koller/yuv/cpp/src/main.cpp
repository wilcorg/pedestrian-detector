 ...
 *
 * Kod, uruchamiający trókanałowy algorytm odejmowania tła.
 */
...
int main() {
    ...
    fs::path outPath = "/home/romka/CLionProjects/koller3/results/";

    Koller3 koller{
            15, 5, 2e-3, 2e-4, 15e-4
    };
    ...
    for (int i = startImg; i <= endImg; i++) {
        ...
        auto img = Koller3::readBgr(imgPath.string(), downscaleFactor);
