...
Odczyt oznaczeń zbioru danych i zapis obiektów poszczególnych klatek do .xml
"""
...
if __name__ == '__main__':
    ...
    GT = pd.read_csv('groundtruth.top', header=None)
    ...
    for frame_number in range(2, train_size):
